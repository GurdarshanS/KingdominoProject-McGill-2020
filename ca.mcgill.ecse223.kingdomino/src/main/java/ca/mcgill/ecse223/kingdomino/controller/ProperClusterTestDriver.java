...
public class ProperClusterTestDriver {
	public static void main (String [] args) {
		...
		int[] id= {31,20,40,30,24,22,38,23,43,13,1,25,19};
		String[] dir= {"right","up","left","up","left","up","right","right","right","down","down","right","right"};
		int[] x= {-1,-1,2,3,2,3,1,0,2,-1,-2,-2,-4,-3};
		int[] y= {1,-1,0,0,-1,-2,-2,-3,-3,-2,-2,-4,-4};
